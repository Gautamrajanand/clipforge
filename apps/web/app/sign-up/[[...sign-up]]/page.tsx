        ...
        <div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg mb-1">Unlimited projects</h3>
                <p className="text-emerald-50">Create as many projects as you need</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-emerald-50">60 processing credits per month included</p>
              </div>
            </div>
          </div>
        </div>
