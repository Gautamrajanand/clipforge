    ...
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl max-w-2xl w-full border border-gray-200">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Select clip</h2>
        ...
        <div className="p-6">
          {/* Video Player */}
          <div className="aspect-video bg-gray-50 rounded-lg mb-4 relative">
            ...
            {/* Duration */}
            <div className="absolute bottom-4 left-4 px-3 py-1 bg-black/80 text-gray-900 text-sm rounded">
              00:00 / {clip.duration}
            </div>
          </div>
          ...
          {/* Clip Info */}
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">{clip.title}</h3>
            
            {/* Virality Score */}
            <div className="flex items-center gap-4 mb-4">
              <div className="text-gray-600 text-sm">Virality Score:</div>
            ...
            <div className="grid grid-cols-4 gap-3">
              <div className="bg-gray-50 rounded-lg p-3 text-center">
                ...
                <div className="text-sm text-gray-600">{clip.metrics.hook}</div>
              </div>
              <div className="bg-gray-50 rounded-lg p-3 text-center">
                <div className="text-xs text-gray-500 mb-1">Flow</div>
                <div className="text-sm text-gray-600">{clip.metrics.flow}</div>
              </div>
              <div className="bg-gray-50 rounded-lg p-3 text-center">
                <div className="text-xs text-gray-500 mb-1">Engagement</div>
                <div className="text-sm text-gray-600">{clip.metrics.engagement}</div>
              </div>
              <div className="bg-gray-50 rounded-lg p-3 text-center">
                <div className="text-xs text-gray-500 mb-1">Trend</div>
                <div className="text-sm text-gray-600">{clip.metrics.trend}</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 px-4 py-3 bg-primary-500 hover:bg-primary-600 text-gray-900 font-semibold rounded-lg transition-colors"
            >
              Select Clip
            </button>
          </div>
